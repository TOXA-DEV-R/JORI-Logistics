<template>
  <Popover v-slot="{ open }" class="relative">
    <PopoverButton
      ...
      class="group inline-flex items-center rounded-md text-base text-black font-medium capitalize focus:outline-none focus-visible:ring-2 focus:font-bold focus-visible:ring-white focus-visible:ring-opacity-75">
